...
**To Test with Paper**: Provide each applicant with an exam, a figure sheet, a bubble answer sheet, pencil/pen and calculator, if needed. The applicant may choose to use the back of the answer sheet for scratch paper or the team can provide the applicant with an blank sheet.
...
**At the end of the session:** The SM cleans up the manifest, will remove any non-participating VEs and add any that did participate. Optionally, remove applicants who did not show. Then Finalize the session.
