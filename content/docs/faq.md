...
**The process:** Download the original, unmodified Official License Copy PDF through [FCC License Manager](https://wireless2.fcc.gov/UlsEntry/licManager/login.jsp), which is part of the FCC's Universal Licensing System (ULS), and upload it to ExamTools. You also sign a legally binding form declaring you are the owner of that callsign. Falsifying that form legally constitutes forgery.
...
Anyone can download a Reference Copy through ULS License Search, so it does not demonstrate control of the callsign. Submit the original, unmodified Official Copy obtained through authenticated License Manager access instead.
...
The verification process requires the original file downloaded through FCC License Manager and a legally binding declaration that you own the callsign. A Reference Copy, modified PDF, scan, or photo does not provide the same evidence of control.

**What if I'm not willing to do this?**
Callsign verification is required for every ExamTools account. VEs who perform no actions in ExamTools and only sign paper forms with a pen do not need an account.
...
- Grade with GradeCam or administer computerized exams
- Generate paper exams or record externally graded results in ExamTools
